...
import com.google.android.apps.mytracks.settings.AbstractSettingsActivity;
...
//  private ListPreference googleAccountListPreference;
  ...
  private Preference registerPreference;
  ...
  protected void onCreate(Bundle bundle) {
    ...
    registerPreference = findPreference(getString(R.string.settings_register_key));
