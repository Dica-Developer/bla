...
import com.nogago.android.maps.utils.StringUtils;
...
public class TcxTrackWriter implements TrackFormatWriter {
  ...
  public void writeBeginTrack(Location firstPoint) {
    if (printWriter != null) {
      String startTime = StringUtils.formatDateTimeIso8601(track.getTripStatistics().getStartTime());
  ...
  private void writeVersion() {
    ...
    printWriter.println("<VersionMajor>" + 1 + "</VersionMajor>");
    printWriter.println("<VersionMinor>" + 1 + "</VersionMinor>");
