...
public class OsmAndFormatter {
	...
	public static String toPublicString(AmenityType t, Context ctx) {
		switch (t) {
		case HIGHWAY:
			return ctx.getString(R.string.amenity_type_highway);
		case WATERWAY:
			return ctx.getString(R.string.amenity_type_waterway);
		case LOCK:
			return ctx.getString(R.string.amenity_type_lock);
		case RAILWAY:
			return ctx.getString(R.string.amenity_type_railway);
		case AEROWAY:
			return ctx.getString(R.string.amenity_type_aeroway);
		case AERIALWAY:
			return ctx.getString(R.string.amenity_type_aerialway);
		case POWER:
			return ctx.getString(R.string.amenity_type_power);
	...
	public static String getPoiSimpleFormat(Amenity amenity, Context ctx, boolean en){
		return getPoiStringWithoutType(amenity, en); //$NON-NLS-1$
	}
