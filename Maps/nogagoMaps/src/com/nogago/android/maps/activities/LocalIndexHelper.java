...
import com.nogago.android.maps.activities.LocalIndexesActivity.LoadLocalIndexTask;
...
import com.nogago.android.maps.voice.MediaCommandPlayerImpl;
import com.nogago.android.maps.voice.TTSCommandPlayerImpl;
...
//				}
	...
	private void updateOdbFileInformation(LocalIndexInfo info){
		AmenityIndexRepositoryOdb odb = (AmenityIndexRepositoryOdb)app.getResourceManager().getAmenityIndexRepositoryByName(info.getFileName());
		StringBuilder builder = new StringBuilder();
		if(odb != null){
			builder.append(app.getString(R.string.local_index_poi_data)).append(": ").append("\n");
			String box = formatLatLonBox(odb.getDataLeftLongitude(), odb.getDataRightLongitude(), 
				odb.getDataTopLatitude(), odb.getDataBottomLatitude());
