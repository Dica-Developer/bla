...
public class ContributionVersionActivity extends OsmandListActivity {
	...
	private File pathToDownload = new File(Environment.getExternalStorageDirectory(), ResourceManager.APP_DIR + "nogagoToInstall.apk");
	...
	protected class OsmandBuildsAdapter extends ArrayAdapter<OsmAndBuild> implements Filterable {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			if (v == null) {
				...
				v = inflater.inflate(com.nogago.android.maps.R.layout.download_build_list_item, parent, false);
			}
			final View row = v;
