    ...
    private Dialog createShareLocationDialog(final Bundle args) {
		...
		builder.setItems(new String[]{
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if(which == 0){
					String email = mapActivity.getString(R.string.send_location_email_pattern, shortOsmUrl);
					...
					String sms = mapActivity.getString(R.string.send_location_sms_pattern, shortOsmUrl);
					if(which == 1){
