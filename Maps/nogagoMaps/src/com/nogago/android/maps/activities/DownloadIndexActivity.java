...
import com.nogago.android.maps.activities.DownloadFileHelper.DownloadFileShowWarning;
import com.nogago.android.maps.plus.DownloadOsmandIndexesHelper;
import com.nogago.android.maps.plus.IndexFileList;
...
import com.nogago.android.maps.plus.DownloadOsmandIndexesHelper.IndexItem;
...
public class DownloadIndexActivity extends OsmandExpandableListActivity {
	...
	private String FREE_VERSION_NAME = "com.nogago.android.free";
			...
			case DIALOG_MAP_VERSION_UPDATE:
				...
				builder.setPositiveButton(R.string.button_upgrade_osmandplus, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://search?q=pname:com.nogago.android.maps"));
						try {
	...
	protected class DownloadIndexAdapter extends OsmandBaseExpandableListAdapter implements Filterable {
		...
		public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
			...
			if (v == null) {
				...
				v = inflater.inflate(com.nogago.android.maps.R.layout.download_index_list_item_category, parent, false);
			}
			final View row = v; 
		...
		public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
			...
			if (v == null) {
				LayoutInflater inflater = getLayoutInflater();
				v = inflater.inflate(com.nogago.android.maps.R.layout.download_index_list_item, parent, false);
			}
			final View row = v; 
