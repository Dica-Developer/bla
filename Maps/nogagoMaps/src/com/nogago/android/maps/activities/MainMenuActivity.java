...
//		footer.startAnimation(getAnimation(0, 1));
		...
		/*
		SharedPreferences prefs = activity.getApplicationContext().getSharedPreferences(OsmandSettings.SHARED_PREFERENCES_NAME, MODE_WORLD_READABLE);
...
//		});
	...
	private void applicationInstalledFirstTime() {
		...
		try {
			ApplicationInfo applicationInfo = getPackageManager().getApplicationInfo(Constants.APP_PACKAGE_NAME, PackageManager.GET_META_DATA);
