...
public class BaseLocationIndexRepository<T extends MapObject> {
	...
	public double getDataTopLatitude() {
		return dataTopLatitude;
	}

	public double getDataBottomLatitude() {
		return dataBottomLatitude;
	}

	public double getDataLeftLongitude() {
		return dataLeftLongitude;
	}

	public double getDataRightLongitude() {
		return dataRightLongitude;
	}
