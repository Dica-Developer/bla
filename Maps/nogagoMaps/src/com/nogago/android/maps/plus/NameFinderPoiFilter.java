...
public class NameFinderPoiFilter extends PoiFilter {
	...
	protected List<Amenity> searchAmenities(double lat, double lon, double topLatitude,
		...
		searchedAmenities.addAll(super.searchAmenities(lat, lon, topLatitude, bottomLatitude, leftLongitude, rightLongitude, matcher));
		if(!searchedAmenities.isEmpty()) return searchedAmenities;
