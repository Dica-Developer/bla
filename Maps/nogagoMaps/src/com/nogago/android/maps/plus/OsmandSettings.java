...
import com.nogago.android.maps.access.RelativeDirectionStyle;
import com.nogago.android.maps.activities.ApplicationMode;
import com.nogago.android.maps.activities.search.SearchHistoryHelper;
...
public class OsmandSettings {
	...
	public static final String SHARED_PREFERENCES_NAME = "com.nogago.android.maps"; //$NON-NLS-1$
	...
	protected OsmandSettings(OsmandApplication application) {
		...
		currentMode = ApplicationMode.PEDESTRIAN;
		
		defaultProfilePreferences = getProfilePreferences(ApplicationMode.PEDESTRIAN);
...
//		}
	...
	protected ApplicationMode readApplicationMode() {
		String s = globalPreferences.getString(APPLICATION_MODE.getId(), ApplicationMode.PEDESTRIAN.name());
		try {
	...
	{
		USE_INTERNET_TO_DOWNLOAD_TILES.setModeDefaultValue(ApplicationMode.PEDESTRIAN, true);
	}
	...
	public final OsmandPreference<Boolean> SHOW_POI_OVER_MAP =
		new BooleanPreference("show_poi_over_map", false, true); // Keine POI bei erstem Start
	...
	public final OsmandPreference<Boolean> SHOW_TRANSPORT_OVER_MAP = 
		new BooleanPreference("show_transport_over_map", false, true); // Keine oepnv bei erstem Start
	...
	public final OsmandPreference<String> USER_NAME = 
		new StringPreference("user_name", "username", true);
	
	// this value string is synchronized with settings_pref.xml preference name
	public final OsmandPreference<String> USER_OSM_BUG_NAME = 
		new StringPreference("user_osm_bug_name", "NoName/nogago", true);
	...
	{
		DAYNIGHT_MODE.setModeDefaultValue(ApplicationMode.PEDESTRIAN, DayNightMode.AUTO);
	...
	*/
	...
	// this value string is synchronized with settings_pref.xml preference name
	public final OsmandPreference<Boolean> TEST_ANIMATE_ROUTING = new BooleanPreference("animate_routing", true, true);
	...
	public final CommonPreference<Boolean> SHOW_RULER = 
			new BooleanPreference("show_ruler", false, false, true);
