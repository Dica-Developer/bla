...
public class Amenity extends MapObject {
	...
	public boolean equals(Object o){
	    ...
	    if(!this.type.toString().equals(other.type.toString())) return false;
	    if(!this.subType.equals(other.subType)) return false;
	    if(this.location.getLatitude() != other.location.getLatitude()) return false;
	    if(this.location.getLongitude() != other.location.getLongitude()) return false;
