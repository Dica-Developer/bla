...
public class TrackRecordingServiceConnectionUtils {
  ...
  public static void resumeTrack(TrackRecordingServiceConnection trackRecordingServiceConnection) {
    try {
      ...
      Log.e(TAG, "Unable to resume track.", ise);
    } catch (StaleDataException sde) {
      Log.e(TAG, "Unable to resume track.", sde);
    }
  }
  ...
  public static void pauseTrack(TrackRecordingServiceConnection trackRecordingServiceConnection) {
    try {
      ...
      Log.e(TAG, "Unable to pause track.", e);
    } catch (IllegalStateException ise) {
      Log.e(TAG, "Unable to pause track.", ise);
    } catch (StaleDataException sde) {
      Log.e(TAG, "Unable to pause track.", sde);
    }
  }
    ...
    if (trackRecordingService != null) {
      try {
        if (showEditor) {
           ...
           */
          long recordingTrackId = PreferencesUtils
              .getLong(context, R.string.recording_track_id_key);
      ...
      try {
        ...
        Log.e(TAG, "Unable to reset recording state.", ise);
      }
    }
   ...
   *          connection
   */
  public static void resumeConnection(Context context,
    ...
    if (!isRecordingServiceRunning(context)) {
      try {
        ...
        Log.e(TAG, "Unable reset recording state", sde);
      }
    }
  }
