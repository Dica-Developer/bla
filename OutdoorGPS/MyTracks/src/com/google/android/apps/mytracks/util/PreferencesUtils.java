...
public class PreferencesUtils {
  ...
  public static final boolean STATS_SHOW_ELEVATION_DEFAULT = true;
  public static final boolean STATS_SHOW_GRADE_DEFAULT = true;
  public static final boolean STATS_SHOW_MOVING_TIME_DEFAULT = true;
